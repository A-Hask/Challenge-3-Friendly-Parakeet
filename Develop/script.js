...
var passwordCriteria = function () {
  ...
  /* If user enters number that is too large or too small, alert window informs them of this and 
    asks them to pick again before returning to start of the function*/
